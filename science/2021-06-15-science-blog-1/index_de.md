...
-   [Welche Zwecke muss die Corona-Warn-App erfüllen?](#zweck)
-   [Erfüllt die Corona-Warn-App ihren Zweck?](#wirkt)
-   [Welches Ziel hat die Evaluation der Corona-Warn-App und welche
    Aspekte spielen dabei eine Rolle?](#evaluation)
-   [Welche Kennzahlen werden bei der Evaluation berücksichtigt und wo
    kommen die Daten dafür her?](#kennzahlen)
-   [Was bringt die Corona-Warn App?](#fazit)
-   [Weitere Themen in den nächsten
    Wochen](#weitere-themen-in-den-nächsten-wochen)

*Seit einem Jahr ist die Corona-Warn-App ein Baustein bei der Eindämmung
der Pandemie. Aber wie wirkt das digitale Tool wirklich und welchen
Nutzen bringt es? Wir werden über die nächsten Wochen Antworten darauf
und Ergebnisse der wissenschaftlichen Evaluation durch das Robert
Koch-Institut hier im Blog veröffentlichen.*

Am 16. Juni 2020 wurde die Corona-Warn-App (CWA) im Apple App Store
sowie im Google Play Store zum Download zur Verfügung gestellt. Seitdem
wurde die App 28,1 Millionen Mal heruntergeladen (Stand: 31. Mai 2021).
Das Robert Koch-Institut gibt die CWA zum digitalen Contact-Tracing von
Personen mit SARS-CoV-2 für die deutsche Bundesregierung heraus.

Eines der wichtigsten Themen, das von Anfang an in der Öffentlichkeit
diskutiert wurde, ist die Frage nach der Wirksamkeit und dem Nutzen der
App. Zur Wirksamkeit einer App zum Contact-Tracing von Personen mit
SARS-CoV-2 und zum Nutzen der CWA liegen bisher wenig empirische Daten
vor. Ihre Erhebung und die wissenschaftliche Evaluation sind notwendig –
und waren von Beginn an geplant.
...
für die Anzahl der Gewarnten nur auf die [Datenspende](#ppa)
...
<figure>
<video src="media/fraunhofer_iis_largeoffice.mp4" style="width:90.0%" controls=""><a href="media/fraunhofer_iis_largeoffice.mp4">BLE-Messungen durch Fraunhofer IIS zur Kallibrierung der Parameter</a></video><figcaption aria-hidden="true"><em>BLE-Messungen durch Fraunhofer IIS zur Kallibrierung der Parameter</em></figcaption>
</figure>
...
zu erheben – eine [ereignisbezogene Befragung](#edus) der Nutzerinnen
...
<figure>
<img src="media/edus_screen.png" style="width:2in" alt="CWA - ereignisbezogene Befragung" /><figcaption aria-hidden="true"><em>CWA - ereignisbezogene Befragung</em></figcaption>
</figure>

</div>

Zur Evaluation gehören eine ereignisbezogene Befragung der Nutzerinnen
und Nutzer: [Event-Driven User Survey, EDUS](#edus) und die Möglichkeit,
regelmäßig Nutzungsdaten über eine Datenspende zur Verfügung zu stellen:
[Privacy Preserving-Analytics, PPA](#ppa).
...
<figure>
<img src="media/ppa_screen.png" style="width:2in" alt="CWA - Datenspende" /><figcaption aria-hidden="true"><em>CWA - Datenspende</em></figcaption>
</figure>
...
<br style="clear:both" /> \#\#\# Kennzahlen aus Backend-Komponenten der
CWA-Infrastruktur {\#backend}
...
Aus den uns im Moment zu Verfügung stehenden [Datenquellen](#kennzahlen)
...
-   Von den Nutzenden, die sich testen ließen und ihr Ergebnis über die
    ...
    [Datenspende](#ppa): 976.084), berichtet eine hohe Anzahl (88 %),
    dass ihr Testergebnis innerhalb von 24 Stunden (724.187 ≃ 74 %) bzw.
    2 Tagen (136.990 ≃ 14 %) einsehbar war.
    $\\color{lightgray}{\\text{(rechtzeitige Wirksamkeit)}}$
...
-   Ein guter Anteil der Nutzenden (61%), die ein positives Testergebnis
    ...
    registriert haben liegt bei (51%). (Siehe [oben](#wirkt).)
    $\\color{lightgray}{\\text{(Nutzen)}}$

-   Viele der Nutzenden (aus [EDUS](#edus): 73% (18.099 von 24.958))
    ...
    auch ohne externe Unterstützung erfolgen kann.
    $\\color{lightgray}{\\text{(zusätzliche Wirksamkeit)}}$

-   Die Mehrheit der Nutzenden, die eine rote Warnung erhalten haben
    (aus [EDUS](#edus): 87% (13.515 von 15.540)), lassen sich
    anschließend auch testen. $\\color{lightgray}{\\text{(Nutzen)}}$

-   In der [ereignisbezogenen Befragung](#edus) waren etwa 6% (792 von
    ...
    in der analogen Kontaktnachverfolgung. In der [Datenspende](#ppa)
    sind dies sogar 12 % (8.467 von 68.531).
    $\\color{lightgray}{\\text{(korrekte Wirksamkeit)}}$
