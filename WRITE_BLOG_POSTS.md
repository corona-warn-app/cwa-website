...
1. Fork the `cwa-website` repository and create a new branch in your fork.
...
- `{PAGE_NAME_DE}` is the same as `{PAGE_NAME}`, but is used for the German website URLs.
